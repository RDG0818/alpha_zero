...
"""Trains the AlphaZero agent on a single machine for Chess"""
import os
...
flags.DEFINE_string('ckpt_dir', './checkpoints/gomoku/13x13', 'Path for checkpoint file.')#HERE
flags.DEFINE_string(
    'logs_dir',
    './logs/gomoku/13x13',
...
from alpha_zero.envs.chess_env import ChessEnv
...
def main():
    ...
    def env_builder():
        return ChessEnv(board_size=FLAGS.board_size, num_stack=FLAGS.num_stack)
